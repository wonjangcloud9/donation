...
async function getMetaverse(x) {
  event.preventDefault();

  try {
    await contract.donate(Number(x));
  } catch (e) {
    alert(
      "Something went wrong! " +
        "Maybe you need to sign out and back in? " +
...
document.getElementById("purchase1").onclick = async () => {
  try {
    await contract.donate(Number(50));
  } catch (e) {
    alert(
      "Something went wrong! " +
        "Maybe you need to sign out and back in? " +
...
document.getElementById("purchase2").onclick = async () => {
  try {
    await contract.donate(Number(50));
  } catch (e) {
    alert(
...
document.getElementById("purchase3").onclick = async () => {
  try {
    await contract.donate(Number(100));
  } catch (e) {
    alert(
      "Something went wrong! " +
        "Maybe you need to sign out and back in? " +
